...
dataValues    = Queue("f", 100, name="Data Collection Buffer")
timeValues    = Queue("L", 100, name="Time Buffer")
...
leftMotorTask  = task_motor(left_motor,  left_encoder,
                            leftMotorGo, setpoint, Kp, Ki, dataValues, timeValues)
rightMotorTask = task_motor(right_motor, right_encoder,
                            rightMotorGo, setpoint, Kp, Ki, dataValues, timeValues)
userTask = task_user(leftMotorGo, rightMotorGo, setpoint, Kp, Ki, dataValues, timeValues)
